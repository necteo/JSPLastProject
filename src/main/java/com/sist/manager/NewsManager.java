...
public class NewsManager {
 ...
 public static String newsSearch(String fd) {
	 String json = "";
     String clientId = "ckK1gpvsAauXWt7hUIay"; //애플리케이션 클라이언트 아이디
     String clientSecret = "lRWQnnOoVn"; //애플리케이션 클라이언트 시크릿
...
//		System.out.println(newsData.toJSONString());
		json = newsData.toJSONString();
	} catch (Exception e) {
		e.printStackTrace();
	}
