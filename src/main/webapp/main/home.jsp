                        ...
                        <div class="col-12">
                            <div class="single-post wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="post-thumb">
                                    <img src="${mainVO.poster }" style="width:700px;height: 450px">
                                </div>
                                <!-- Post Content -->
                                    ...
                                    <div class="post-meta d-flex">
                                        <div class="post-author-date-area d-flex">
                                            ...
                                            <div class="post-author">
                                                <a href="#">${mainVO.type }</a>
                                            </div>
                                            <!-- Post Date -->
                                            <div class="post-date">
                                                <a href="#">${mainVO.address }</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="post-comment-share-area d-flex">
                                            ...
                                            <div class="post-favourite">
                                                <a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i> ${mainVO.likecount }</a>
                                            </div>
                                            <!-- Post Comments -->
                                            <div class="post-comments">
                                                <a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i> ${mainVO.replycount }</a>
                                            </div>
                                            <!-- Post Share -->
